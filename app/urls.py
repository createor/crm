...
from app.utils import UPLOAD_IMAGE_DIR, UPLOAD_EXCEL_DIR, TEMP_DIR, ALLOWED_EXTENSIONS, methods, crmLogger, redisClient, getUuid, getCaptcha, verify, scan_file
...
def download_help():
    ...
    crmLogger.info(f"用户{g.username}成功下载手册{filename}")
